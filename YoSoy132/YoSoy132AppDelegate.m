...
#import "YoSoy132AppDelegate.h"

@implementation YoSoy132AppDelegate
...
-(void) estiloHead{
    ...
    UIImage *navimage = [[UIImage imageNamed:@"head01.png"]resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
